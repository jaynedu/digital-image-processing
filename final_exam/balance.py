...
def white_balance_5(img):
    ...
    avl_r = sum_r / (num_rgb+0.00001)
    avl_g = sum_g / (num_rgb+0.00001)
    avl_b = sum_b / (num_rgb+0.00001)

    for i in range(m):
        for j in range(n):
            b_point = int(b[i][j]) * int(max_y) / (avl_b + 0.00001)
            g_point = int(g[i][j]) * int(max_y) / (avl_g + 0.00001)
            r_point = int(r[i][j]) * int(max_y) / (avl_r + 0.00001)
            if b_point > 255:
                b[i][j] = 255
            else:
                if b_point < 0:
...
list1, list2 = [], []
img1 = white_balance_1(img1)
img2 = white_balance_1(img2)
list1.append(img1)
list2.append(img2)
img1 = white_balance_2(img1)
img2 = white_balance_2(img2)
list1.append(img1)
list2.append(img2)
img1 = white_balance_3(img1)
img2 = white_balance_3(img2)
list1.append(img1)
list2.append(img2)
img1 = white_balance_4(img1)
img2 = white_balance_4(img2)
list1.append(img1)
list2.append(img2)
...
for img1, img2 in zip(list1, list2):
    ...
    cv2.imwrite('sift_matching_result_%d.png' % i, newimg)